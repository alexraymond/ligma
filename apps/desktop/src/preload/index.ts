...
const api = {
  ...
  claudeCli: {
    status: () => ipcRenderer.invoke('claude-cli:v1:status') as Promise<ClaudeCliStatus>,
    add: () => ipcRenderer.invoke('claude-cli:v1:add') as Promise<ClaudeCliStatus>,
    remove: () => ipcRenderer.invoke('claude-cli:v1:remove') as Promise<ClaudeCliStatus>,
  },
  connection: {
    test: (input: {
      provider: SupportedOnboardingProvider;
