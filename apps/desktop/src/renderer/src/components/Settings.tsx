import { setLocale as applyLocale, useT } from '@ligma/i18n';
...
import { ClaudeCliLoginCard } from './ClaudeCliLoginCard';
 ...
 * Strip the wrapper so toast descriptions read like natural sentences
 * instead of framework tracebacks.
 */
  ...
  return (
    <>
      ...
      <div className="space-y-[var(--space-3)]">
        ...
        <ClaudeCliLoginCard onStatusChange={reloadRows} />
