 ...
 * Latin shorthand regardless of locale. Uses Intl.RelativeTimeFormat so
 * the output matches the active UI locale. Callers should pass the current
 * locale; tests pin it explicitly so expected strings stay deterministic.
 */
