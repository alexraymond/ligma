cask "ligma" do
  ...
  on_arm do
    url "https://github.com/alexraymond/ligma/releases/download/v#{version}/ligma-#{version}-arm64.dmg",
        verified: "github.com/alexraymond/ligma/"
    sha256 "dc2997ad9e283d9f11320501f84dca9d56e9c9ec96b84d90a84160e71e20b34b"
  end
  on_intel do
    url "https://github.com/alexraymond/ligma/releases/download/v#{version}/ligma-#{version}-x64.dmg",
        verified: "github.com/alexraymond/ligma/"
  ...
  homepage "https://alexraymond.github.io/ligma/"
