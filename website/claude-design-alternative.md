...
[Download Ligma →](https://github.com/alexraymond/ligma/releases) · [Quickstart (90 s)](./quickstart)

## At a glance

Claude Design is a hosted web app by Anthropic that runs Claude Opus on their infrastructure. Ligma is a desktop app you run on your own machine with whichever model provider you already use.
...
No. Ligma is an independent, clean-room open-source project built by alexraymond. It shares no code with Anthropic's Claude Design. The name "Claude Design" belongs to Anthropic; Ligma is an independent alternative, not affiliated with Anthropic.
...
- **Does it send anything to the cloud?** Only the prompts you send to your own model provider. Nothing goes to alexraymond or a shared backend.
