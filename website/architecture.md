---
title: Architecture
description: How Ligma is laid out across packages and apps.
---
...
For data-flow walkthroughs (single generation, inline comment, slider drag), see the per-package `README.md` files in the [monorepo](https://github.com/TODO-MORNING/ligma/tree/main/packages).
