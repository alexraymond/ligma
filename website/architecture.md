...
For data-flow walkthroughs (single generation, inline comment, slider drag), see the per-package `README.md` files in the [monorepo](https://github.com/alexraymond/ligma/tree/main/packages).
