...
layout: home
title: Ligma
titleTemplate: AI Design Tool — BYOK, Local-First
description: Ligma is a desktop AI design tool — a self-hosted alternative to Claude Design. Bring your own API key (Anthropic, OpenAI, Gemini, DeepSeek, Ollama). Everything runs locally.
...
hero:
  ...
  actions:
    - theme: brand
      ...
      link: https://github.com/alexraymond/ligma/releases
    - theme: alt
      text: Star on GitHub
      link: https://github.com/alexraymond/ligma
    - theme: alt
...
|                       | Models             | Runs locally | Pricing             |
| --------------------- | :----------------: | :----------: | :-----------------: |
| **Ligma**     | **Any (BYOK)**     | **✓**        | **Token cost only** |
| Claude Design         | Opus only          | ✗            | Subscription        |
| v0 by Vercel          | Curated            | ✗            | Subscription        |
| Lovable               | Curated            | ✗            | Subscription        |
| Bolt.new              | Curated            | ✗            | Subscription        |
...
<div class="codesign-community">
  <div class="community-card">
    <h3>GitHub</h3>
    <p class="community-hint">Bug reports, feature requests, and async discussion all happen in Issues. Security issues → <a href="https://github.com/alexraymond/ligma/blob/main/SECURITY.md">SECURITY.md</a>.</p>
    <p class="community-cta"><a href="https://github.com/alexraymond/ligma/issues" class="community-button">Open Issues →</a></p>
  </div>
</div>
...
<a href="https://github.com/alexraymond/ligma" class="cta-secondary">View on GitHub</a>
