 ...
 *
 * NOTE: a near-identical API_KEY_RE lives in ligma-classic's
 * `src/main/diagnostics-ipc.ts` — the constant is duplicated rather than
 * imported across module layers. Per CLAUDE.md "three similar lines is
 * fine", the duplication is intentional.
 */
