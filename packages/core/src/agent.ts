...
const AGENTIC_TOOL_GUIDANCE = [
  ...
  'like "design my fintech app" reads as a half-finished response.',
  '',
  ...
  '',
  '### Required cadence',
  '1. **First turn — plan.** Call `set_todos` with **7–10 checklist items**. The shape of the list depends on whether the brief is single-file or multi-file:',
