 ...
 *
 * Exported for callers that own their own directory-walking convention (a
 * `SKILL.md` inside a per-skill folder, rather than this module's flat
 * `<dir>/*.md` tiers) but still want the same inline YAML parser rather than a
 * second implementation or a new dependency.
 */
