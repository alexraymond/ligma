...
function locate(d: {
  ...
  // LIGMA_CHROME_PATH is the current name; CODESIGN_CHROME_PATH is kept as a
  // legacy alias from the pre-rebrand env var name (fix-campaign decision 7).
  const override = d.env['LIGMA_CHROME_PATH'] || d.env['CODESIGN_CHROME_PATH'];
